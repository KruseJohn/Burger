...
![label](https://github.com/KruseJohn/Burger/blob/master/public/assets/img/burger2.png)
A Burger Eatin' Application With Node.js/Express/MySQL/Handlebars/Bootstrap

## Description

This application demonstrates a simple full stack application with the front end implemented with HTML/CSS and elements from the Bootstrap framework. The backend is implemented with Node.js and Express. HTML templating is done with the help of Handlebars.
